...
export const NewsletterBox = () => (
  <section className="bg-slate-700 not-prose rounded-xl overflow-hidden">
    <img src="/images/dungeon-map-extra-wide.webp" />
    <div className="p-8">
      <h2 className="font-bold mb-4 text-2xl">Join my GM newsletter!</h2>
      <p className="mb-2 italic text-lg font-semibold">
        Sign up and get a free one page dungeon for D&D 5e
      </p>
