...
meta:
  ...
  - property: og:title
    content: "Using Notion as a DM Screen"
  - property: og:description
    content: >
      A guide on how to use Notion to build a digital DM Screen to run D&D 5e
      games using my ready-to-use template
  - property: og:image
    content: https://kennygoff.com/images/og-images/using-notion-dm-screen.png
  - property: og:type
    content: website
  - property: og:url
    content: https://kennygoff.com/using-notion-dm-screen
