...
meta:
  title: Using Notion as a DM Screen
  description: How to use Notion to build a DM Screen to run D&D 5e games
---
...
campaign. If you try out my template, [let me know](mailto:hi@kennygoff.com) how
it goes. I'm planning to adjust the template with improvements over time so any
feedback is welcome!
