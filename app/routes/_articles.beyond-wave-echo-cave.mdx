...
meta:
  ...
  - property: og:title
    content: "Beyond Wave Echo Cave: Expanding Lost Mines of Phandelver"
  - property: og:description
    content: >
      Advice for Dungeon Masters on continuing a D&D 5e campaign after the Lost
      Mines of Phandelver adventure finishes
  - property: og:image
    content: https://kennygoff.com/images/og-images/beyond-wave-echo-cave.png
  - property: og:type
    content: website
  - property: og:url
    content: https://kennygoff.com/beyond-wave-echo-cave
