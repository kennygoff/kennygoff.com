...
meta:
  ...
  - property: og:title
    content: "Owlbear Rodeo: The painless virtual tabletop"
  - property: og:description
    content: >
      A breakdown of the Owlbear Rodeo virtual tabletop's best features, some
      areas it could improve, and the bright future it has
  - property: og:image
    content: https://kennygoff.com/images/og-images/owlbear-rodeo-the-painless-virtual-tabletop.png
  - property: og:type
    content: website
  - property: og:url
    content: https://kennygoff.com/owlbear-rodeo-the-painless-virtual-tabletop
