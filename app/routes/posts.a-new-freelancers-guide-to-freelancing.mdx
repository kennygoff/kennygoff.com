...
meta:
  ...
  - property: og:title
    content: "A new freelancer's guide to freelancing"
  - property: og:description
    content: >
      Advice about getting into freelancing, from a new freelancer. Including
      best ways to get started, set your prices, and sharing your work
  - property: og:image
    content: https://kennygoff.com/images/og-images/a-new-freelancers-guide-to-freelancing.png
  - property: og:type
    content: website
  - property: og:url
    content: https://kennygoff.com/posts/a-new-freelancers-guide-to-freelancing
