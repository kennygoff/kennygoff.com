...
meta:
  title: A new freelancer's guide to freelancing
  description:
    Advice about getting into freelancing, from a new freelancer. Including best
    ways to get started, set your prices, and sharing your work.
---
...
<PostDate date={attributes.published} />

<PostCallout
  title={`Update ${attributes.updated.toLocaleDateString()}`}
