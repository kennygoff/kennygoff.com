...
meta:
  ...
  - property: og:title
    content: "Freelance, burnout, and Double Turn: 4 Years of Inwave Labs"
  - property: og:description
    content: >
      Reflections on four years running Inwave Labs, my small indie game
      development studio, and freelancing along the way
  - property: og:image
    content: https://kennygoff.com/images/og-images/inwave-labs-4-years.png
  - property: og:type
    content: website
  - property: og:url
    content: https://kennygoff.com/posts/inwave-labs-4-years
